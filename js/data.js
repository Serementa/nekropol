...
const TIMELINE = [
  {date:"Август 2025", status:"done", title:"Первый выезд на некрополь", desc:"Мы выехали на историческое кладбище, провели GPS-съёмку 78 точек и сфотографировали все доступные объекты"},
  {date:"Август 2025", status:"done", title:"Предпроектный анализ", desc:"Мы исследовали российские и зарубежные аналоги: Таганрог, Слободской, Одесса, проект «Свод русских надписей»"},
  {date:"Сентябрь 2025", status:"done", title:"Создание каталога", desc:"Мы составили каталог исторических захоронений: описали 54 объекта по 15 параметрам"},
  {date:"Сентябрь 2025", status:"done", title:"Архивная работа", desc:"Мы привязали данные к исповедной росписи 1827 года и подтвердили 4 фамилии: Мануилов, Кабельков, Сонин, Крамаров"},
  {date:"Октябрь 2025", status:"done", title:"Консультация по 3D", desc:"Мы провели консультацию с А. А. Зиганшиной из проекта «Свод русских надписей» по методологии 3D-моделирования через Agisoft Metashape"},
  {date:"Март 2026", status:"done", title:"Схема и координаты", desc:"Мы создали схему расположения надгробий с координатами, выявили дубли и пропуски в данных"},
  ...
  {date:"Март 2026", status:"active", title:"Расширение базы данных", desc:"Мы доснимаем точки 25, 26, 35, 76, 81 и разделяем точку 44 на отдельные объекты"},
  {date:"Q2 2026", status:"planned", title:"Типология крестов", desc:"Мы классифицируем кресты по форме и сравним с аналогами Одессы (Сапожников И. В.) и Невинномысска"},
  {date:"Q3 2026", status:"planned", title:"3D-моделирование", desc:"Мы смоделируем 20–30 объектов через Agisoft Metashape и прочитаем надписи через карту высот"},
  {date:"Q4 2026", status:"planned", title:"Виртуальный тур и презентация", desc:"Мы создадим виртуальный тур по некрополю, подготовим итоговую презентацию и подадим на грант"},
];

const SOURCES = [
  {title:"Проект «Свод русских надписей»", url:"https://cir.rssda.su/", type:"method"},
  {title:"Методология моделирования (Свод)", url:"https://cir.rssda.su/methodology/", type:"method"},
  ...
  {title:"Путеводитель по Старому кладбищу Таганрога (PDF)", url:"http://vivaldi.taglib-collection.ru/book/2024/staroe_kladbishche_taganroga.pdf/view/", type:"analogue"},
  {title:"Виртуальное путешествие — Таганрог", url:"https://marfano.ru/pltg/", type:"analogue"},
  {title:"Куяльницкое кладбище — Pixelated Realities (ЕС)", url:"https://pixelatedrealities.org/uk/portfolio/czvyntar-sotnykivskoyi-sichi/", type:"analogue"},
  ...
  {title:"ЖЖ-блоги с аналогичными кладбищами", url:"https://photo-discovery.livejournal.com/5400218.html", type:"blog"},
];
