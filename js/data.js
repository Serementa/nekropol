...
const TIMELINE = [
  {date:"Август 2025", status:"done", title:"Первый выезд на некрополь", desc:"GPS-съёмка 78 точек, фотофиксация всех доступных объектов"},
  {date:"Август 2025", status:"done", title:"Предпроектный анализ", desc:"Исследование российских и зарубежных аналогов: Таганрог, Слободской, Одесса, проект «Свод русских надписей»"},
  {date:"Сентябрь 2025", status:"done", title:"Создание каталога", desc:"Каталог исторических захоронений: 54 объекта описаны, 15 колонок данных"},
  {date:"Сентябрь 2025", status:"done", title:"Архивная работа", desc:"Привязка данных к исповедной росписи 1827 года (Мануилов, Кабельков, Сонин, Крамаров)"},
  {date:"Октябрь 2025", status:"done", title:"Консультация по 3D", desc:"Консультация с А. А. Зиганшиной (проект «Свод русских надписей») по методологии 3D-моделирования через Agisoft Metashape"},
  {date:"Март 2026", status:"done", title:"Схема и координаты", desc:"Создание схемы расположения надгробий с координатами, выявление дублей и пропусков"},
  {date:"Март 2026", status:"active", title:"Сайт проекта", desc:"Разработка многостраничного сайта с интерактивной картой, каталогом и хроникой"},
  {date:"Март 2026", status:"active", title:"Расширение базы данных", desc:"Досъёмка точек 25, 26, 35, 76, 81; разделение точки 44 на отдельные объекты"},
  {date:"Q2 2026", status:"planned", title:"Типология крестов", desc:"Классификация по форме, сравнение с аналогами Одессы (Сапожников И. В.) и Невинномысска"},
  {date:"Q3 2026", status:"planned", title:"3D-моделирование", desc:"Моделирование 20–30 объектов через Agisoft Metashape, чтение надписей через карту высот"},
  {date:"Q4 2026", status:"planned", title:"Виртуальный тур и презентация", desc:"Виртуальный тур по некрополю, итоговая презентация, подача на грант"},
];
