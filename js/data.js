...
const TIMELINE = [
  ...
  {date:"Q3 2026", status:"planned", title:"Виртуальный тур и презентация", desc:"Мы создадим виртуальный тур по некрополю, подготовим итоговую презентацию и представим её на фестивале «Легенды поколений 2026»"},
  {date:"Q4 2026", status:"planned", title:"3D-моделирование", desc:"Ищем волонтёров, чтобы сделать 3D-модели якорных объектов некрополя"},
];
