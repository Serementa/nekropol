...
const TIMELINE = [
  {date:"Июль 2025", status:"done", title:"Первый день фестиваля "Легенды поколений"", desc:"На кладбище работали три команды: одни раскапывали занесенные пыльной бурей надгробия, другие укрепляли фундамент у некоторых памятников, третьи фотографировали все доступные объекты"},
  {date:"Август 2025", status:"done", title:"Предпроектный анализ", desc:"Мы провели исследование и пытались найти российские и зарубежные аналоги проектов по сохранению казачьих некрополей. Оказалось, что прицельно ими никто раньше не замнимался. Мы исследовали похожие историко-культурыне и научные проекты и поняли, каким мы хотим видеть наш.»"},
  {date:"Сентябрь 2025", status:"done", title:"Создание каталога", desc:"Волонтеры собрали сделанные фото. Мы их систематизировали. Из этих материалов у нас родился каталог исторических захоронений: мы описали 54 объекта по 15 параметрам"},
  {date:"Ноябрь 2025", status:"done", title:"Архивная работа", desc:"Мы привязали выявленные на памятниках данные к историческим документам И НАПИСАТЬ ЧТО ДАЛЬШЕ "},
  {date:"Декабрь 2026", status:"done", title:"Схема и координаты", desc:"Выявили в каталоге дубли, сделали второй выезд и замерили координаты всех объектов"},
  ...
  {date:"Март 2026", status:"active", title:"Расширение базы данных", desc:"Мы доснимаем точки, верифицируем полученные координаты и фактическое местположение, собираем всю инофрмацию о развитии проекта с самого его начала"},
  {date:"Q2 2026", status:"planned", title:"Типология крестов", desc:"Планируем сделать классификацию крестов по форме. Сравним их аналогами Невинномысска, Одессы, уцелевших образцов в других станицах "},
  {date:"Q3 2026", status:"planned", title:"Виртуальный тур и презентация", desc:"Мы создадим виртуальный тур по некрополю, подготовим итоговую презентацию и представим ее на фестивале "Легенды поколений 2026""},
  {date:"Q4 2026", status:"planned", title:"3D-моделирование", desc:"Ищем волонтеров чтобы сделать 3D модели якорных объектов некрполя"},
];
